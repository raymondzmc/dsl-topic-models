...
from dsl_topic.models._vendored.octis.pytorchavitm.datasets.bow import BOWDataset
from dsl_topic.models._vendored.octis.pytorchavitm.model import AVITM_model
