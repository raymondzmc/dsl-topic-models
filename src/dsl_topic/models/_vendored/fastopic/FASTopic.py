...
from dsl_topic.models._vendored.fastopic import _plot
from dsl_topic.models._vendored.fastopic import _fastopic
from dsl_topic.models._vendored.fastopic._utils import Logger, assert_fitted, check_fitted, DocEmbedModel, Dataset, get_top_words
...
class FASTopic:
    def __init__(
        ...
        if preprocess is None:
            from dsl_topic.models._vendored.topmost.preprocess import Preprocess
