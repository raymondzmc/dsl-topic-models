...
from dsl_topic.models.baselines.fastopic import _fastopic
from dsl_topic.models.baselines.fastopic._utils import Logger, assert_fitted, check_fitted, DocEmbedModel, Dataset, get_top_words
